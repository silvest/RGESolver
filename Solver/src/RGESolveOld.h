...
public:
    ...
    //New Stuff
    /**
     * @brief Generating the SM conditions with SM beta functions only.
     * @param mu The scale at which the SM initial conditions are computed.
     * @param basis (UP or DOWN)
     */
